...
> 위 설명된 CVE-2025-6205 취약점 exploit이 선행된 후 인증된 사용자가 파일 업로드 할 때, 확장자 및 filename 파라미터의 path traversal 문자를 검증되지 않아 웹 쉘 업로드가 가능한 취약점 입니다.

<br><br>

1. **취약한 앤드포인트 타겟 식:** 인증되지 않은 사용자가 임의로 생성한 계정으로 로그인 후 취약한 앤드포인트를 CVE 보고서를 통해 확인합니다.


<img width="824" height="718" alt="image" src="https://github.com/user-attachments/assets/b6696e74-6930-4305-8106-41c1f445ef3f" />
